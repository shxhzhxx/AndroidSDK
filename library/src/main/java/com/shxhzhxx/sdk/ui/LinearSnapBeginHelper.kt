...
class LinearSnapBeginHelper : LinearSnapHelper() {
    private val horizontalMethod = LinearSnapHelper::class.java.getDeclaredMethod("getHorizontalHelper", RecyclerView.LayoutManager::class.java).apply { isAccessible = true }
    private val verticalMethod = LinearSnapHelper::class.java.getDeclaredMethod("getVerticalHelper", RecyclerView.LayoutManager::class.java).apply { isAccessible = true }
